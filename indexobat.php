...
<body>
    ...
    <div class="container">
        ...
        $hasil_select = mysqli_query($kon, $sql_select);
        ...
        <table class="table table-bordered table-custom">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="updateobat.php?id_obat=<?php echo htmlspecialchars($data['id_obat']); ?>"
                            class="btn btn-warning" role="button">Update</a>
                        <a href="hapusobat.php?id_obat=<?php echo htmlspecialchars($data['id_obat']); ?>"
        ...
        <div class="pagination">
            ...
            $query_total = mysqli_query($kon, $sql_total);
