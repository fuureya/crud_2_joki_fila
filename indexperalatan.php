...
<body>
    ...
    <div class="container">
        ...
        <table class="table table-bordered table-custom">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="updateperalatan.php?id_peralatan=<?php echo htmlspecialchars($data['id_peralatan']); ?>"
                            class="btn btn-warning btn-action" role="button">Update</a>
                    </td>
                    <td>
        ...
        <?php
            ...
            $hasil_total = mysqli_query($kon, $sql_total);
